  ...
  return (
    <div className="app-container">
      ...
      >
        ...
        <p style={{ color: '#7a7a8f', fontSize: '18px', fontWeight: '500' }}>Your wellness, smarter.</p>
      </div>
      ...
      <div style={{ marginTop: 'auto', paddingBottom: '20px' }}>
        ...
        <div className="bottom-link" style={{ marginTop: '32px' }}>
          New to the sanctuary? <Link to="/signup/1">Create an account</Link>
        </div>
